...
/*   Updated: 2021/06/10 14:16:47 by bhatches         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void 		test_updatevalue_env_lst(t_main prmtrs)
{
	...
	env_lstadd_back(&prmtrs.env_head, env_lstnew(env_split("Z1="), 1));
	env_lstadd_back(&prmtrs.env_head, env_lstnew(env_split("Z2=new"), 1));
